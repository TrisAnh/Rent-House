    ...
    const fetchPackages = async () => {
      try {
        const response = await axios.get(
          "https://be-android-project.onrender.com/api/packages/active"
        );
        setPackages(response.data);
      } catch (err) {
        console.error("Error fetching packages:", err);
        setError(
          err.response?.data?.error || "Lỗi khi tải danh sách gói bài đăng"
        );
      } finally {
  ...
  const handleBuyPackage = async (pkgId) => {
    ...
    try {
      const response = await axios.post(
        "https://be-android-project.onrender.com/api/packages/payment",
        {
          packageId: pkgId,
        },
        {
