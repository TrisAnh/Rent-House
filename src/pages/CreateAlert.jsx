...
const PostAlertSubscriptionForm = ({ open, onClose }) => {
  ...
  const handleDistrictChange = (e) => {
    ...
    const districtName =
      districts.find((district) => district.code === districtCode)?.name || "";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        criteria: {
          // Đổi tên từ priceRange, roomTypes, sizeRange thành đúng tên trong schema
      ...
      const response = await axios.post(
        "https://be-android-project.onrender.com/api/alert/create",
        payload,
        {
          headers: {
